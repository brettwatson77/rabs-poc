            ...
            {activeTab === 'general' && (
              <>
                ...
                <div className="form-section">
                  ...
                  {/* Relationship - moved from Health tab */}
                  <div className="form-group">
                  ...
                  {/* Contact Email + toggles - moved from Health tab */}
                  <div className="form-group">
                ...
                {/* Support Details - moved from Health tab */}
                <div className="form-section">
